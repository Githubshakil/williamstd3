        ...
        <div className=' bg-ladyPink max-w-[1440px] max-h-[722px] m-auto mt-9 py-[150px] px-[185px] relative'>
            ...
            <div className='customContainer  '>
                <div className='flex justify-between items-center '>
                    <div>
                        <h4 className='font-manufont text-[18px] font-bold  text-lg text-[#ffffff] mb-5 '>About Me</h4>
                        <h3 className='max-w-[560px] text-3xl text-[#ffffff] font-manufont font-bold'>You can’t  use up creativity.
                            The more you use, the more 
                            you have in your signifant mind.
                        </h3>
                        <p className='max-w-[501px] text-[#ffffff] text-base mt-8 mb-[70px] font-manufont font-normal leading-6'>
                    ...
                    <div>
                        <h3 className='max-w-[360px] text-3xl text-[#ffffff] mb-8 font-manufont font-bold text '>
                            Any type of question & Discussion.
                        </h3>
                        <p className='max-w-[501px] text-[#ffffff] text-base mt-8 mb-8  font-manufont font-normal leading-6'>
                            Being the savage's bowsman, that is, the person who pulled the bow-oar in his boat
                        </p>
                        <span className='text-[#ffffff]  font-bold font-manufont ' >WilliamAndersons@william.std</span>
                    </div>
                </div>
