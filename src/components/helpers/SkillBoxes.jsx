    ...
    <div className='group relative h-[370px] w-[370px] border-solid border-2 border-light hover:bg-ladyPink duration-300 pl-[50px] pr-[50px] pt-[50px] pb-[36px] overflow-hidden' >
      <div className='w-[325px] h-[325px] bg-gradient-to-r from-[#F46C88] to-[rgba(251,165,189,0.2)] rounded-full absolute -left-[73px] -top-12 z-[1] opacity-0 group-hover:opacity-100 duration-300'></div>
        <div className='relative z-10'>
            <h5 className=' font-Montserrat text-lightBlack text-2xl group-hover:text-white duration-300 '>{boxInnerTitle}</h5>
            ...
            <a href="#" className='inline-flex justify-center items-center gap-x-2  font-Montserrat font-bold
                    uppercase transition-all  text-secondary group-hover:text-white duration-300'>LEARN MORE<MdOutlineArrowForwardIos/>
            </a>
        </div>
    </div>
    </>
